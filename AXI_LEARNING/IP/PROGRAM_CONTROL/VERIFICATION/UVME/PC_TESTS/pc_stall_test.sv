class pc_stall_test extends uvm_test;

  `uvm_component_utils(pc_stall_test)
  ...
  function new(string name="pc_stall_test", uvm_component parent);
  ...
  task run_phase(uvm_phase phase);
    ...
    begin
      ...
      `uvm_info("Test Scenario : 6 ", $sformatf(" Directed Test Case "), UVM_LOW) 
      //Stall condition
      seq.count = 1;
      seq.scenario =6; // Starting test scenario - based on control signals.
      `uvm_info("Test Scenario : 6 ", $sformatf(" Stall, No. of stalls = %d",seq.count), UVM_LOW)   
      ...
      seq.count = 2;
      seq.scenario =6; // Starting test scenario - based on control signals.
      `uvm_info("Test Scenario : 6 ", $sformatf(" Stall, No. of branches = %d",seq.count), UVM_LOW)   
      seq.stall_valid_i_seq    =1;
      seq.start(env.pc_agnt.pc_seqr);
