module i2c_slave_controller(
	input logic i2c_rst  , // global reset signal
...
timeprecision 1ps;
	...
	logic 	    wr_en_out_in   ; // i2c_slave wr_en_out to ram wr_en 
	logic        rd_en_out_in   ; // i2c_slave rd_en_out to ram rd_en 
	logic [7:0]  addr_i2c_to_ram; // i2c_slave addr_out to ram addr_in 
	logic [7:0]  data_i2c_to_ram; // i2c_slave data_out to ram data_in
	logic [7:0]  data_ram_to_i2c; // ram data_out to i2c_slave data_in
