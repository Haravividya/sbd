...
class i2cm_test_alternative extends uvm_test;

  `uvm_component_utils(i2cm_test_alternative)
  
  //env and sequence instantiation
  i2cm_env env_inst;
  i2cm_sequence seqnc_inst;
 
  function new(string name="i2cm_test_alternative", uvm_component parent=null) ;
