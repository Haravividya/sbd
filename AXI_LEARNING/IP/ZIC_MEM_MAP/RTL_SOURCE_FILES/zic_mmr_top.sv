...
(
    ...
    input logic 		      zic_mmr_write_en_i	,
    input logic 		[15:0]zic_mmr_write_addr_i	,
    input logic 		[31:0]zic_mmr_write_data_i	,
    input logic 		      zic_mmr_read_en_i	    ,
    input logic 		[15:0]zic_mmr_read_addr_i	,
    output logic 		[31:0]zic_mmr_read_data_o	,
    //////////////////////////////////////////
    //signals to zic 
    output logic [7:0] 	irq0_ctrl_o		,// [7:0] - zic_ip
    output logic [7:0] 	irq1_ctrl_o		,
    output logic [7:0] 	irq2_ctrl_o		,
    output logic [7:0] 	irq3_ctrl_o		,
    output logic [7:0] 	irq4_ctrl_o		,
    output logic [7:0] 	irq5_ctrl_o		,
    output logic [7:0] 	irq6_ctrl_o		,
    output logic [7:0] 	irq7_ctrl_o		,
    output logic [7:0] 	irq8_ctrl_o		,
    output logic [7:0] 	irq9_ctrl_o		,
    output logic [7:0] 	irq10_ctrl_o		,
    output logic [7:0] 	irq11_ctrl_o		,
    output logic [7:0] 	irq12_ctrl_o		,
    output logic [7:0] 	irq13_ctrl_o		,
    output logic [7:0] 	irq14_ctrl_o		,
    output logic [7:0] 	irq15_ctrl_o		,
    output logic [7:0] 	irq16_ctrl_o		,
    output logic [7:0] 	irq17_ctrl_o		,
    output logic [7:0] 	irq18_ctrl_o		,
    output logic [7:0] 	irq19_ctrl_o		,
    output logic [7:0] 	irq20_ctrl_o		,
    output logic [7:0] 	irq21_ctrl_o		,
    output logic [7:0] 	irq22_ctrl_o		,
    output logic [7:0] 	irq23_ctrl_o		,
    output logic [7:0] 	irq24_ctrl_o		,
    output logic [7:0] 	irq25_ctrl_o		,
    output logic [7:0] 	irq26_ctrl_o		,
    output logic [7:0] 	irq27_ctrl_o		,
    output logic [7:0] 	irq28_ctrl_o		,
    output logic [7:0] 	irq29_ctrl_o		,
    output logic [7:0] 	irq30_ctrl_o		,
    output logic [7:0] 	irq31_ctrl_o		,
    output logic [7:0] 	irq32_ctrl_o		,
    output logic [7:0] 	irq33_ctrl_o		,
    output logic [7:0] 	irq34_ctrl_o		,
    output logic [7:0] 	irq35_ctrl_o		,
    output logic [7:0] 	irq36_ctrl_o		,
    output logic [7:0] 	irq37_ctrl_o		,
    output logic [7:0] 	irq38_ctrl_o		,
    output logic [7:0] 	irq39_ctrl_o		,
    output logic [7:0] 	irq40_ctrl_o		,
    output logic [7:0] 	irq41_ctrl_o		,
    output logic [7:0] 	irq42_ctrl_o		,
    output logic [7:0] 	irq43_ctrl_o		,
    output logic [7:0] 	irq44_ctrl_o		,
    output logic [7:0] 	irq45_ctrl_o		,
    output logic [7:0] 	irq46_ctrl_o		,
    output logic [7:0] 	irq47_ctrl_o		,
    output logic [47:0] zic_int_en_o		,
    output logic        wdt_irq_o	        ,
    //acknowledgement signals
    input logic 		    zic_ack_write_valid_i		,//ack int id write enable from zic
    input logic     [7:0] 	zic_ack_int_id_i		    ,//ack int id from zic
    input logic 		    zic_ack_read_valid_en		,//ack int id read en from processor
    output logic 	[7:0]	zic_ack_int_id_o		    ,//to processor ack
    output logic 		    zic_ack_o			        ,//acknowledgement signal to zic
    //end of interrupt signals
    input logic 		    zic_eoi_valid_i			    ,//eoi write enable from processor
    input logic     [7:0] 	zic_eoi_id_i			    ,//eoi int id from processor
    output logic 		    zic_eoi_o			        ,//eoi signal to zic
    //next pending interrupt id signals
    input logic 		    zic_nxtp_valid_i		    ,//from zic to reg file
    input logic     [7:0] 	zic_nxtp_id_i			    ,//from zic to reg file
    //interrupt pending signals
    input logic 		    zic_int_pending_valid_i 	,//lets make one bit	
    input logic     [47:0] 	zic_int_pending_bit_i		,
    //interrupt enable signals
    input logic 	[47:0]	global_int_enable_bit_i		,
    input logic  	  	    global_int_enable_valid_i	,//lets make one bit
    ...
    output logic            wdt_reset_o
       ...
       logic [31:0] wdt_timeout_reg_w;
       logic [31:0] wdt_counter_w	 ;
       logic [31:0] wdt_ctrl_w	     ;
      
     logic   [7:0] 	ack_int_id_w	  ;
     logic   [7:0] 	zic_eoi_id_w	  ;
     logic   [7:0] 	zic_cfg_w	      ;
     logic   [31:0] zic_info_w	      ;
     logic   [7:0] 	zic_nxtp_w	      ;
    
     logic [31:0]irq0_ctrl_w; 
     logic [31:0]irq1_ctrl_w; 
     logic [31:0]irq2_ctrl_w; 
     logic [31:0]irq3_ctrl_w; 
     logic [31:0]irq4_ctrl_w; 
     logic [31:0]irq5_ctrl_w; 
     logic [31:0]irq6_ctrl_w; 
     logic [31:0]irq7_ctrl_w; 
     logic [31:0]irq8_ctrl_w; 
     logic [31:0]irq9_ctrl_w; 
     logic [31:0]irq10_ctrl_w; 
     logic [31:0]irq11_ctrl_w;
     logic [31:0]irq12_ctrl_w;
     logic [31:0]irq13_ctrl_w;
     logic [31:0]irq14_ctrl_w;
     logic [31:0]irq15_ctrl_w;
     logic [31:0]irq16_ctrl_w;
     logic [31:0]irq17_ctrl_w;
     logic [31:0]irq18_ctrl_w;
     logic [31:0]irq19_ctrl_w;
     logic [31:0]irq20_ctrl_w;
     logic [31:0]irq21_ctrl_w;
     logic [31:0]irq22_ctrl_w;
     logic [31:0]irq23_ctrl_w;
     logic [31:0]irq24_ctrl_w;
     logic [31:0]irq25_ctrl_w;
     logic [31:0]irq26_ctrl_w;
     logic [31:0]irq27_ctrl_w;
     logic [31:0]irq28_ctrl_w;
     logic [31:0]irq29_ctrl_w;
     logic [31:0]irq30_ctrl_w;
     logic [31:0]irq31_ctrl_w;
     logic [31:0]irq32_ctrl_w;
     logic [31:0]irq33_ctrl_w;
     logic [31:0]irq34_ctrl_w;
     logic [31:0]irq35_ctrl_w;
     logic [31:0]irq36_ctrl_w;
     logic [31:0]irq37_ctrl_w;
     logic [31:0]irq38_ctrl_w;
     logic [31:0]irq39_ctrl_w;
     logic [31:0]irq40_ctrl_w;
     logic [31:0]irq41_ctrl_w;
     logic [31:0]irq42_ctrl_w;
     logic [31:0]irq43_ctrl_w;
     logic [31:0]irq44_ctrl_w;
     logic [31:0]irq45_ctrl_w;
     logic [31:0]irq46_ctrl_w;
     logic [31:0]irq47_ctrl_w;
