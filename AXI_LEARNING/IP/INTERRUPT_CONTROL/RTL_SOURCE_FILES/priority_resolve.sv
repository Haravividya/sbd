...
(
  ...
  input logic       [47:0]  int_pending_i               ,
  input logic 		[7:0] 	int0_lp_i			        ,//interrupt level priority value
  input logic 		[7:0] 	int1_lp_i			        ,
  ...
  output logic 	    [7:0] 	interrupt_id_o		        ,
  output logic  	[7:0]   highest_pending_lvl_pr_o    ,
  output logic              highest_pending_lvl_pr_valid
   ...
   logic [7:0] 	int0_lp_w		     ;	//interrupt level priority value
   logic [7:0] 	int1_lp_w		     ;	
   logic [7:0] 	int2_lp_w		     ;	
   logic [7:0] 	int3_lp_w		     ;	
   logic [7:0] 	int4_lp_w		     ;	
   ...
   logic [7:0] 	int8_lp_w		     ;	
   logic [7:0] 	int9_lp_w		     ;	
   logic [7:0] 	int10_lp_w		     ;	
   logic [7:0] 	int11_lp_w		     ;	
   logic [7:0] 	int12_lp_w		     ;	
   logic [7:0] 	int13_lp_w		     ;	
   logic [7:0] 	int14_lp_w		     ;	
   logic [7:0] 	int15_lp_w		     ;	
   logic [7:0] 	int16_lp_w		     ;	
   logic [7:0] 	int17_lp_w		     ;	
   logic [7:0] 	int18_lp_w		     ;	
   logic [7:0] 	int19_lp_w		     ;	
   logic [7:0] 	int20_lp_w		     ;	
   logic [7:0] 	int21_lp_w		     ;	
   logic [7:0] 	int22_lp_w		     ;	
   logic [7:0] 	int23_lp_w		     ;	
   logic [7:0] 	int24_lp_w		     ;	
   logic [7:0] 	int25_lp_w		     ;	
   logic [7:0] 	int26_lp_w		     ;	
   logic [7:0] 	int27_lp_w		     ;	
   logic [7:0] 	int28_lp_w		     ;	
   logic [7:0] 	int29_lp_w		     ;	
   logic [7:0] 	int30_lp_w		     ;	
   logic [7:0] 	int31_lp_w		     ;	
   logic [7:0] 	int32_lp_w		     ;	
   logic [7:0] 	int33_lp_w		     ;	
   logic [7:0] 	int34_lp_w		     ;	
   logic [7:0] 	int35_lp_w		     ;	
   logic [7:0] 	int36_lp_w		     ;	
   logic [7:0] 	int37_lp_w		     ;	
   logic [7:0] 	int38_lp_w		     ;	
   logic [7:0] 	int39_lp_w		     ;	
   logic [7:0] 	int40_lp_w		     ;	
   logic [7:0] 	int41_lp_w		     ;	
   logic [7:0] 	int42_lp_w		     ;	
   logic [7:0] 	int43_lp_w		     ;	
   logic [7:0] 	int44_lp_w		     ;	
   logic [7:0] 	int45_lp_w		     ;	
   logic [7:0] 	int46_lp_w		     ;	
   logic [7:0] 	int47_lp_w		     ;	
   ...
   logic [7:0] stage_id0_0          ;
   logic [7:0] stage_id0_1          ;
   logic [7:0] stage_id0_2          ;
   logic [7:0] stage_id0_3          ;
   logic [7:0] stage_id0_4          ;
   logic [7:0] stage_id0_5          ;
   logic [7:0] stage_id0_6          ;
   logic [7:0] stage_id0_7          ;
   logic [7:0] stage_id0_8          ;
   logic [7:0] stage_id0_9          ;
   logic [7:0] stage_id0_10         ;
   logic [7:0] stage_id0_11         ;
   logic [7:0] stage_id0_12         ;
   logic [7:0] stage_id0_13         ;
   logic [7:0] stage_id0_14         ;
   logic [7:0] stage_id0_15         ;
   logic [7:0] stage_id0_16         ;
   logic [7:0] stage_id0_17         ;
   logic [7:0] stage_id0_18         ;
   logic [7:0] stage_id0_19         ;
   logic [7:0] stage_id0_20         ;
   logic [7:0] stage_id0_21         ;
   logic [7:0] stage_id0_22         ;
   logic [7:0] stage_id0_23         ;
   logic [7:0] stage_id1_0          ;
   logic [7:0] stage_id1_1          ;
   logic [7:0] stage_id1_2          ;
   logic [7:0] stage_id1_3          ;
   logic [7:0] stage_id1_4          ;
   logic [7:0] stage_id1_5          ;
   logic [7:0] stage_id1_6          ;
   logic [7:0] stage_id1_7          ;
   logic [7:0] stage_id1_8          ;
   logic [7:0] stage_id1_9          ;
   logic [7:0] stage_id1_10         ;
   logic [7:0] stage_id1_11         ;
   logic [7:0] stage_id2_0          ;
   logic [7:0] stage_id2_1          ;
   logic [7:0] stage_id2_2          ;
   logic [7:0] stage_id2_3          ;
   logic [7:0] stage_id2_4          ;
   logic [7:0] stage_id2_5          ;
   logic [7:0] stage_id3_0          ;
   logic [7:0] stage_id3_1          ;
   logic [7:0] stage_id3_2          ;
   logic [7:0] stage_id4_0          ;
   logic [7:0] stage_id5_0          ;
    ...
    (
      input logic       [7:0] val_in_1    ,
      input logic       [7:0] val_in_2    ,
      input logic       [7:0] val1_id     ,
      input logic       [7:0] val2_id     ,
