...
(
  input logic 		    zic_clk				        ,
  input logic 		    zic_rst				        ,
  input logic 		    zic_mmr_write_en_i		    ,//from core
  input logic 	[15:0]	zic_mmr_write_addr_i	    ,//from core
  input logic 	[31:0]	zic_mmr_write_data_i	    ,//from core
  input logic 		    zic_mmr_read_en_i		    ,//from core
  input logic 	[15:0]	zic_mmr_read_addr_i		    ,//from core
  output logic 	[31:0]	zic_mmr_read_data_o		    ,//to core
 ...
 timeprecision 1ps;*/
   ...
   logic		zic_ack_write_valid_w		;
   logic [7:0] 	zic_ack_int_id_w		    ;
   logic		zic_ack_w			        ;
   logic		zic_eoi_w			        ;
   logic		zic_nxtp_valid_w		    ;
   logic [7:0] 	zic_nxtp_id_w			    ;
   logic		zic_int_pending_valid_w		;
   logic [47:0] zic_int_pending_bit_w	    ;
   logic [7:0] 	irq0_ctrl_w 			    ; 
   logic [7:0] 	irq1_ctrl_w 			    ; 
   logic [7:0] 	irq2_ctrl_w 			    ; 
   logic [7:0] 	irq3_ctrl_w 			    ; 
   logic [7:0] 	irq4_ctrl_w 			    ; 
   logic [7:0] 	irq5_ctrl_w 			    ; 
   logic [7:0] 	irq6_ctrl_w 			    ; 
   logic [7:0] 	irq7_ctrl_w 			    ; 
   logic [7:0] 	irq8_ctrl_w 			    ; 
   logic [7:0] 	irq9_ctrl_w 			    ; 
   logic [7:0] 	irq10_ctrl_w			    ; 
   logic [7:0] 	irq11_ctrl_w			    ;
   logic [7:0] 	irq12_ctrl_w			    ;
   logic [7:0] 	irq13_ctrl_w			    ;
   logic [7:0] 	irq14_ctrl_w			    ;
   logic [7:0] 	irq15_ctrl_w			    ;
   logic [7:0] 	irq16_ctrl_w			    ;
   logic [7:0] 	irq17_ctrl_w			    ;
   logic [7:0] 	irq18_ctrl_w			    ;
   logic [7:0] 	irq19_ctrl_w			    ;
   logic [7:0] 	irq20_ctrl_w			    ;
   logic [7:0] 	irq21_ctrl_w			    ;
   logic [7:0] 	irq22_ctrl_w			    ;
   logic [7:0] 	irq23_ctrl_w			    ;
   logic [7:0] 	irq24_ctrl_w			    ;
   logic [7:0] 	irq25_ctrl_w			    ;
   logic [7:0] 	irq26_ctrl_w			    ;
   logic [7:0] 	irq27_ctrl_w			    ;
   logic [7:0] 	irq28_ctrl_w			    ;
   logic [7:0] 	irq29_ctrl_w			    ;
   logic [7:0] 	irq30_ctrl_w			    ;
   logic [7:0] 	irq31_ctrl_w			    ;
   logic [7:0] 	irq32_ctrl_w			    ;
   logic [7:0] 	irq33_ctrl_w			    ;
   logic [7:0] 	irq34_ctrl_w			    ;
   logic [7:0] 	irq35_ctrl_w			    ;
   logic [7:0] 	irq36_ctrl_w			    ;
   logic [7:0] 	irq37_ctrl_w			    ;
   logic [7:0] 	irq38_ctrl_w			    ;
   logic [7:0] 	irq39_ctrl_w			    ;
   logic [7:0] 	irq40_ctrl_w			    ;
   logic [7:0] 	irq41_ctrl_w			    ;
   logic [7:0] 	irq42_ctrl_w			    ;
   logic [7:0] 	irq43_ctrl_w			    ;
   logic [7:0] 	irq44_ctrl_w			    ;
   logic [7:0] 	irq45_ctrl_w			    ;
   logic [7:0] 	irq46_ctrl_w			    ;
   logic [7:0] 	irq47_ctrl_w			    ;
