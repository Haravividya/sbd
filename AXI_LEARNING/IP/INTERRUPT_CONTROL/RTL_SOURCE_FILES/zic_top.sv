...
module zic_top
(
    input logic 	       		zic_clk		        	,//global clock
    input logic 	       		zic_rst		        	,//global reset
    input logic                 wdt_reset_i             ,
    input logic 		[47:0]  interrupt_enable_i  	,//from memory mapped register
    input logic 	       		ext_int0_i	        	,//external interrupt lines 0 to 47
    input logic 	       		ext_int1_i	        	,
    input logic 	       		ext_int2_i	        	,
    input logic 	       		ext_int3_i	        	,
    input logic 	       		ext_int4_i	        	,
    input logic 	       		ext_int5_i	        	,
    input logic 	       		ext_int6_i	        	,
    input logic 	       		ext_int7_i	        	,
    input logic 	       		ext_int8_i	        	,
    input logic 	       		ext_int9_i	        	,
    input logic 	       		ext_int10_i	        	,
    input logic 	       		ext_int11_i	        	,
    input logic 	       		ext_int12_i	        	,
    input logic 	       		ext_int13_i	        	,
    input logic 	       		ext_int14_i	        	,
    input logic 	       		ext_int15_i	        	,
    input logic 	       		ext_int16_i	        	,
    input logic 	       		ext_int17_i	        	,
    input logic 	       		ext_int18_i	        	,
    input logic 	       		ext_int19_i	        	,
    input logic 	       		ext_int20_i	        	,
    input logic 	       		ext_int21_i	        	,
    input logic 	       		ext_int22_i	        	,
    input logic 	       		ext_int23_i	        	,
    input logic 	       		ext_int24_i	        	,
    input logic 	       		ext_int25_i	        	,
    input logic 	       		ext_int26_i	        	,
    input logic 	       		ext_int27_i	        	,
    input logic 	       		ext_int28_i	        	,
    input logic 	       		ext_int29_i	        	,
    input logic 	       		ext_int30_i	        	,
    input logic 	       		ext_int31_i	        	,
    input logic 	       		ext_int32_i	        	,
    input logic 	       		ext_int33_i	        	,
    input logic 	       		ext_int34_i	        	,
    input logic 	       		ext_int35_i	        	,
    input logic 	       		ext_int36_i	        	,
    input logic 	       		ext_int37_i	        	,
    input logic 	       		ext_int38_i	        	,
    input logic 	       		ext_int39_i	        	,
    input logic 	       		ext_int40_i	        	,
    input logic 	       		ext_int41_i	        	,
    input logic 	       		ext_int42_i	        	,
    input logic 	       		ext_int43_i	        	,
    input logic 	       		ext_int44_i	        	,
    input logic 	       		ext_int45_i	        	,
    input logic 	       		ext_int46_i	        	,
    input logic 	       		ext_int47_i	        	,
    input logic 		[7:0] 	int0_lp_i	        	,//interrupt level priority value from zic mmr 
    input logic 		[7:0] 	int1_lp_i	        	,//each interrupt has corresponding predefined level-priority value 
    input logic 		[7:0] 	int2_lp_i	        	,
    input logic 		[7:0] 	int3_lp_i	        	,
    input logic 		[7:0] 	int4_lp_i	        	,
    input logic 		[7:0] 	int5_lp_i	        	,
    input logic 		[7:0] 	int6_lp_i	        	,
    input logic 		[7:0] 	int7_lp_i	        	,
    input logic 		[7:0] 	int8_lp_i	        	,
    input logic 		[7:0] 	int9_lp_i	        	,
    input logic 		[7:0] 	int10_lp_i	        	,
    input logic 		[7:0] 	int11_lp_i	        	,
    input logic 		[7:0] 	int12_lp_i	        	,
    input logic 		[7:0] 	int13_lp_i	        	,
    input logic 		[7:0] 	int14_lp_i	        	,
    input logic 		[7:0] 	int15_lp_i	        	,
    input logic 		[7:0] 	int16_lp_i	        	,
    input logic 		[7:0] 	int17_lp_i	        	,
    input logic 		[7:0] 	int18_lp_i	        	,
    input logic 		[7:0] 	int19_lp_i	        	,
    input logic 		[7:0] 	int20_lp_i	        	,
    input logic 		[7:0] 	int21_lp_i	        	,
    input logic 		[7:0] 	int22_lp_i	        	,
    input logic 		[7:0] 	int23_lp_i	        	,
    input logic 		[7:0] 	int24_lp_i	        	,
    input logic 		[7:0] 	int25_lp_i	        	,
    input logic 		[7:0] 	int26_lp_i	        	,
    input logic 		[7:0] 	int27_lp_i	        	,
    input logic 		[7:0] 	int28_lp_i	        	,
    input logic 		[7:0] 	int29_lp_i	        	,
    input logic 		[7:0] 	int30_lp_i	        	,
    input logic 		[7:0] 	int31_lp_i	        	,
    input logic 		[7:0] 	int32_lp_i	        	,
    input logic 		[7:0] 	int33_lp_i	        	,
    input logic 		[7:0] 	int34_lp_i	        	,
    input logic 		[7:0] 	int35_lp_i	        	,
    input logic 		[7:0] 	int36_lp_i	        	,
    input logic 		[7:0] 	int37_lp_i	        	,
    input logic 		[7:0] 	int38_lp_i	        	,
    input logic 		[7:0] 	int39_lp_i	        	,
    input logic 		[7:0] 	int40_lp_i	        	,
    input logic 		[7:0] 	int41_lp_i	        	,
    input logic 		[7:0] 	int42_lp_i	        	,
    input logic 		[7:0] 	int43_lp_i	        	,
    input logic 		[7:0] 	int44_lp_i	        	,
    input logic 		[7:0] 	int45_lp_i	        	,
    input logic 		[7:0] 	int46_lp_i	        	,
    input logic 		[7:0] 	int47_lp_i	        	,
    input logic 		[7:0] 	active_lvl_pr_i			,//active interrupt levl-priority value	
    input logic 			    zic_eoi_valid_i			,//end of interrupt valid signal from core/zic_mmr
    input logic               	zic_ack_in          		,//interrupt request acknowledge signal from core/zic_mmr
    input logic       	[7:0]  	zic_ack_id_in       		,//interrupt id of acknowledged interrupt
    output logic 			    interrupt_request_o		    ,//interrupt request signal to core	    		
    output logic 		[7:0] 	interrupt_id_o			    ,//interrupt id of requested interrupt   			
    output logic	   		    interrupt_id_valid_o		,//valid signal for requested interrupt id
    output logic  	    [47:0]  interrupt_pending_o		    ,//interrupt pending signal fr each interrupt line to zic_mmr
    output logic 			    interrupt_pending_valid_o	,
    output logic 			    zic_nxtp_valid_o	 	    ,//from zic to reg file
    output logic 		[7:0] 	highest_pending_lvl_pr_o 	,
    output logic  	    [7:0] 	zic_nxtp_id_o			    , //from zic to reg file
 ...
 logic        [7:0] interrupt_id_w			        ;				
 logic        [7:0] highest_pending_lvl_pr_w		;	
 logic 	            highest_pending_lvl_pr_valid_w	;	
