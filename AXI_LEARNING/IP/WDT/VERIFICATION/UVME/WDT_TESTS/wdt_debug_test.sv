class wdt_debug_test extends uvm_test;

  `uvm_component_utils(wdt_debug_test)

  wdt_env wdt_en;
  wdt_debug_seq wdt_seq;
//  logic [15:0] test_timer;
  ...
  task run_phase(uvm_phase phase);
    ...
    begin
      ...
      wdt_seq = wdt_debug_seq::type_id::create("wdt_seq",this);
     // test_timer    = 16'h0010;
    //  wdt_seq.timer = test_timer;
     if($value$plusargs("TEST_CASE=%d",test_case)==49)
     begin
