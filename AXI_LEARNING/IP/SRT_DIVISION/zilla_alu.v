...
output      [DATA_WIDTH-1:0]         product_out    , 
input   stall_pipeline,
input                              div_word_valid_i            ,
input                              rem_word_valid_i
...
begin
    ...
    begin
        if(div_word_valid_i)
        begin
            data_out_1_o = {{DATA_WIDTH-1{quotient[31]}},quotient[31:0]};
        end
        else
        begin
    ...
    begin
        //data_out_1_o = remainder;
         if(rem_word_valid_i)
        begin
            data_out_1_o = {{DATA_WIDTH-1{remainder[31]}},remainder[31:0]};
        end
        else
        begin
            data_out_1_o = remainder;
...
begin
		...
		begin
			...
			pc_r 		<= pc_w          ;
                    ...
                    //product_valid_r <= product_valid;
                    product_valid_o <= product_valid;
                    //abc = div_word_valid_i;
...
begin
  ...
  assign mult_en_r2 = ((mult_en && (!mult_en_r))&& (!stall_pipeline));
