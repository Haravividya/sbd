...
File name:ahb_slave_burst4_test.sv
************************************************************************/

//user defined class derived from base class 
class ahb_slave_burst4_test extends ahb_slave_test_tb;

//factory registration
 `uvm_component_utils(ahb_slave_burst4_test) 

//constructor
  function new(string name="ahb_slave_burst4_test",uvm_component parent=null);
...
//run phase 
  task run_phase(uvm_phase phase);
     ...
     phase.raise_objection(this); //raising objection to test the scenarios 	
      `uvm_info(get_name(),$sformatf("step 1 : inside test = ahb_slave_burst4_test"),UVM_MEDIUM);
     ...
     repeat(50)
      ...
      `uvm_info(get_name(),$sformatf("step 6 : inside test done = ahb_slave_burst4_test"),UVM_MEDIUM);
