...
File name:ahb_slave_hburst_test.sv
************************************************************************/

//user defined class derived from base class 
class ahb_slave_hburst_test extends ahb_slave_test_tb;

//factory registration
 `uvm_component_utils(ahb_slave_hburst_test) 

//constructor
  function new(string name="ahb_slave_hburst_test",uvm_component parent=null);
...
//run phase 
  task run_phase(uvm_phase phase);
    ...
    `uvm_info(get_name(),$sformatf("step 1 : inside test = ahb_slave_hburst_test"),UVM_MEDIUM);
    ...
    `uvm_info(get_name(),$sformatf("step 6 : inside test done = ahb_slave_hburst_test"),UVM_MEDIUM);
