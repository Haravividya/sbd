...
File name:ahb_slave_burst8_test.sv
************************************************************************/

//user defined class derived from base class 
class ahb_slave_burst8_test extends ahb_slave_test_tb;

  //factory registration
  `uvm_component_utils(ahb_slave_burst8_test) 

  //constructor
  function new(string name="ahb_slave_burst8_test",uvm_component parent=null);
  ...
  task run_phase(uvm_phase phase);
    ...
    `uvm_info(get_name(),$sformatf("step 1 : inside test = ahb_slave_burst8_test"),UVM_MEDIUM)        
    repeat(50)
    begin             
      //scenario 1
	  seq_inst.scenario = 1;
      ...
      `uvm_info(get_name(),$sformatf("step 6 : inside test done = ahb_slave_burst8_test"),UVM_MEDIUM);
