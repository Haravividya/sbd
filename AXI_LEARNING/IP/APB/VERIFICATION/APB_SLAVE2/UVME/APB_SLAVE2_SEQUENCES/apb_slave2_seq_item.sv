class apb_slave2_seq_item#(int ADDR_WIDTH=64, DATA_WIDTH=64) extends uvm_sequence_item;
	...
	`uvm_object_utils_begin(apb_slave2_seq_item) 
		...
		`uvm_field_int(pslverr2, UVM_ALL_ON)
		`uvm_field_int(pready2, UVM_ALL_ON)
		`uvm_field_int(prdata2, UVM_ALL_ON)
		`uvm_field_int(wait_time, UVM_ALL_ON)
		
	`uvm_object_utils_end

	//constructor 
	function new (string name ="apb_slave2_seq_item");
		super.new(name);
	//	`uvm_info("apb_slave2_seq_item ", $sformatf("sequence item - bundling"), UVM_LOW)
	endfunction
