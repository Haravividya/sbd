...
module apb_slave2_tb_top;

   import uvm_pkg::*;
   import apb_slave2_pkg::*;
...
apb_slave2_interface intf(pclock);
...
apb_slave2 DUT(
    ...
    .pwrite(intf.pwrite),
	.pwdata(intf.pwdata),
	.prdata2(intf.prdata2),
	.pslverr2(intf.pslverr2),
	.pready2(intf.pready2)
       );
...
//	$dumpfile("waveforms.vcd");
 //   $dumpvars(0,apb_slave2_tb_top);
    // $dumpfile("dump.vcd"); $dumpvars;  
    uvm_config_db#(virtual apb_slave2_interface)::set(null,"","intf",intf); 
//	`uvm_info("Test Bench top", $sformatf("Test Bench : Entry"), UVM_LOW)
	run_test("apb_slave2_test");  //apb_slave2_test file is called //debug
