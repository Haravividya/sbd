...
class apb_slave2_test extends uvm_test;

  `uvm_component_utils(apb_slave2_test)
  //Declare Env and sequence 
   apb_slave2_env env;
   apb_slave2_sequence seq;
   ...
   function void build_phase (uvm_phase phase);
      ...
      seq = apb_slave2_sequence :: type_id :: create("seq");
   ...
   // forever
	...
	repeat(20)
		...
		seq.start(env.apb_slave2_agnt.sequencer);
         ...
         seq.scenario     = 1;           			
			seq.paddr_seq    = 32'h11;
			seq.pwdata_seq   = 32'h200;
	     	seq.pwrite_seq   = 1;
			seq.psel2_seq    = 1;
			seq.penable_seq  = 1;			
			seq.start(env.apb_slave2_agnt.sequencer);
    ...
    /* 
            seq.scenario     = 1;           			
			seq.paddr_seq    = 32'h13;
			seq.pwdata_seq   = 32'h750;
			seq.pwrite_seq   = 1;
			seq.psel2_seq    = 1;
			seq.penable_seq  = 1;			
			seq.start(env.apb_slave2_agnt.sequencer);
      */
            ...
            seq.scenario     = 1;           			
			seq.paddr_seq    = 32'h14;
			seq.pwdata_seq   = 32'h250;
			seq.pwrite_seq   = 1;
			seq.psel2_seq    = 1;
			seq.penable_seq  = 0;			
			seq.start(env.apb_slave2_agnt.sequencer);
            ...
            seq.scenario     = 1;           			
			seq.paddr_seq    = 32'h15;
			seq.pwdata_seq   = 32'h78;
			seq.pwrite_seq   = 1;
			seq.psel2_seq    = 0;
			seq.penable_seq  = 1;			
			seq.start(env.apb_slave2_agnt.sequencer);
            ...
            seq.scenario     = 1;           			
			seq.paddr_seq    = 32'h16;
			seq.pwdata_seq   = 32'h85;
			seq.pwrite_seq   = 1;
			seq.psel2_seq    = 1;
			seq.penable_seq  = 0;			
			seq.start(env.apb_slave2_agnt.sequencer);
