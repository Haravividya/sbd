...
class apb_slave2_monitor extends uvm_monitor;
 
   // Virtual Interface
   virtual apb_slave2_interface intf;
 
   uvm_analysis_port #(apb_slave2_seq_item) item_collected_port;
 
   // Placeholder to capture transaction information.
   apb_slave2_seq_item trans_collected;
  
  `uvm_component_utils(apb_slave2_monitor)
 ...
 task run_phase(uvm_phase phase);
  //  @ (posedge intf.presetn);
   ...
   forever
     // trans_collected= apb_slave2_seq_item :: type_id :: create("trans_collected");
     begin
    	...
    	trans_collected.psel2     = intf.psel2;
     	trans_collected.penable   = intf.penable;
    	trans_collected.prdata2   = intf.prdata2;
        trans_collected.pready2   = intf.pready2;
        trans_collected.pslverr2  = intf.pslverr2;
