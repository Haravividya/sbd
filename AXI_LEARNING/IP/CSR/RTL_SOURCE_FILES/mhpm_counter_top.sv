...
(
    ...
    input logic 	[DATA_WIDTH-1:0]	    mhpm_counter_csr_inhibit_bit	,
    ...
    */
    ...
    module mhpm_counter_csr#(parameter MHPM_COUNTER = 12'h0,
    			 parameter MHPM_EVENT = 12'h0,
             parameter CSR_ADDR_WIDTH    = 0,
    parameter DATA_WIDTH        = 0,
    parameter INSTRUCTION_WIDTH = 0,
    parameter PC_WIDTH          = 0
    ...
    input logic 	   [CSR_ADDR_WIDTH-1:0] 	csr_write_addr			,
    input logic      [DATA_WIDTH-1:0] 	csr_write_data			,
    //input logic 	   [DATA_WIDTH-1:0]	mhpm_event			,
    input logic 			mhpm_counter_csr_inhibit_bit	,
    output logic  [DATA_WIDTH-1:0] 	mhpm_counter_o		,
    output logic  [DATA_WIDTH-1:0]  mhpm_event_o    ,
    input logic           dbg_csr_write_en_i      ,
    input logic [CSR_ADDR_WIDTH-1:0]    dbg_csr_addr_i          ,
    input logic [DATA_WIDTH-1:0]    dbg_csr_write_data_i    ,
    input logic           debug_mode_valid_i      ,
    ...
    localparam RST_VAL = 0;
     logic [DATA_WIDTH-1:0] mhpm_counter_r;
     logic [DATA_WIDTH-1:0] mhpm_event;//323
    // logic [DATA_WIDTH-1:0] mhpm_counter_r1;
