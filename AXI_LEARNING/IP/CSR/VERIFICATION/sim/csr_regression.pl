################# CSR REGRESSION SCRIPT FOR ALL TESTS ###############################

##Command to run this scrpit with coverage : "perl csr_regression.pl <test_list.f> <1>"
...
sub simulate_test 
{
  ...
  my ($test) = @_;
   {   
    ...
    {  
      system("xrun -access +rwc -f ../UVME/CSR_comp_file.f  -svseed $seed +UVM_TESTNAME=$test +define+UVM_REPORT_DISABLE_FILE_LINE -uvmhome CDNS-1.1d"); 
    }
