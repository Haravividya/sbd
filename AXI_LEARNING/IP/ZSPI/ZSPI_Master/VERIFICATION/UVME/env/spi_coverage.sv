...
// uvm_subscriber is a standard uvm component to implement coverage : this will be analysis import 
  ...
  // Covergroup 
  covergroup covgroup_spi_master;
    ...
    TX_READY : coverpoint txn.tx_ready // 1 bit
    { bins bin_value_0 = {0};
      bins bin_value_1 = {1};
    }
    ...
    SCLK : coverpoint txn.sclk // 1 bit
    { 	  
      bins bin_value_0 = {0};
      bins bin_value_1 = {1};
    }
    ...
    CROSS_COVERAGE: cross RESET, TX_READY,DATA_IN,MISO;    //cross coverage
