...
class spi_seq extends uvm_sequence#(spi_seq_item);
  ...
  int       scenario   ;
  bit       reset_seq  ;
  bit       rx_e_seq,miso_seq,tx_ready_seq;
  bit [7:0] data_in_seq;
  ...
  virtual task body();
      ...
      begin
        `uvm_do_with(seq_item_inst,
		             {seq_item_inst.reset == reset_seq;
                      ...
                      seq_item_inst.miso == miso_seq;
                      seq_item_inst.data_in == data_in_seq;
                      seq_item_inst.tx_ready == tx_ready_seq;
                     });
      end
	end
    ...
    // scenario 5 random data means all inputs are randomised
	if(scenario == 5) 
    begin
    ...
    begin
      ...
      begin
        ...
        begin
          start_item(seq_item_inst);
          assert(seq_item_inst.randomize() with {
                      tx_ready==0; reset==1;seq_item_inst.data_in==data_in_seq;
                      });
          finish_item(seq_item_inst);
        end
	  end
    ...
    begin
       ...
       begin
        ...
        begin
          start_item(seq_item_inst);
          assert(seq_item_inst.randomize() with {
                      tx_ready==0;seq_item_inst.data_in==data_in_seq;
                      });
          finish_item(seq_item_inst);
        end
	  end
    ...
    //scenario 9 transmission of data for random tx_ready signal
    if(scenario == 9) 
    begin
    ...
    begin
      ...
      begin
        ...
        begin
          start_item(seq_item_inst);
          assert(seq_item_inst.randomize() with {
                      tx_ready==0; seq_item_inst.data_in==data_in_seq; rx_e==1;
                      });
          finish_item(seq_item_inst);
        end
	  end
    ...
    begin
      ...
      begin
        ...
        begin
          start_item(seq_item_inst);
          assert(seq_item_inst.randomize() with {
                      tx_ready==0; seq_item_inst.data_in==data_in_seq; rx_e==0;
                      });
          finish_item(seq_item_inst);
        end
	  end
