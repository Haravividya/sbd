  ...
  task run_phase(uvm_phase phase);
    ...
    begin
      ...
      //pmpcfg2 with NA4 with both read and write access
       ...
       repeat(1)
        ...
        begin
         ...
         seq_inst.csr_write_data_seq=32'h3A2542B3;
         //seq_inst.csr_write_en_seq=1;
         seq_inst.pmp_en_seq=0;
         seq_inst.kernel_mode_signal_seq = 0;
          seq_inst.start(env_inst.agent_inst.sequencer_inst);
      ...
      repeat(1) 
       ...
       //pmpcfg0 with NA4 with   write access 011 combination
        repeat(1) 
	    begin 

         seq_inst.csr_write_addr_seq = 12'h3A0;
         seq_inst.csr_write_data_seq = 32'h13131313;   //pmpcfg0 with NA4 with both read and write access 
         seq_inst.pmp_en_seq = 0;
         seq_inst.kernel_mode_signal_seq = 0;
       ...
       //pmpcfg1 with NA4 with  write access 011
       repeat(1) 
	    begin 

         seq_inst.csr_write_addr_seq = 12'h3A1;
         seq_inst.csr_write_data_seq = 32'h13131313;   //pmpcfg1 with NA4 with both read and write access 
         seq_inst.pmp_en_seq = 0;
         seq_inst.kernel_mode_signal_seq = 0;
         ...
         //pmpcfg2 with NA4 with write access  011
       repeat(1) 
	    begin 
        ...
        //pmpcfg3 with NA4 with write access 011
       repeat(1) 
	    begin 

         seq_inst.csr_write_addr_seq = 12'h3A3;
         seq_inst.csr_write_data_seq = 32'h13131313;   //pmpcfg3 with NA4 with write access  011
         seq_inst.pmp_en_seq = 0;
         seq_inst.kernel_mode_signal_seq = 0;
      ...
      repeat(1) 
       ...
       repeat(1) 
        ...
        // seq_inst.csr_write_addr_seq = 12'h3B0;
         ...
         //pmpcfg0 with NA4 with  001 combination
        repeat(1) 
	    begin 

         seq_inst.csr_write_addr_seq = 12'h3A0;
         seq_inst.csr_write_data_seq = 32'h11111111;   //pmpcfg0 with NA4 with 001 
         seq_inst.pmp_en_seq = 0;
         seq_inst.kernel_mode_signal_seq = 0;
         seq_inst.start(env_inst.agent_inst.sequencer_inst);
        end
         ...
         //pmpcfg1 with NA4 with  001 combination
       repeat(1) 
	    begin 

         seq_inst.csr_write_addr_seq = 12'h3A1;
         seq_inst.csr_write_data_seq = 32'h11111111;   //pmpcfg1 with NA4 with 101
         seq_inst.pmp_en_seq = 0;
         seq_inst.kernel_mode_signal_seq = 0;
         seq_inst.start(env_inst.agent_inst.sequencer_inst);
        end 

        //pmpcfg2 with NA4   001
       repeat(1) 
	    begin 

         seq_inst.csr_write_addr_seq = 12'h3A2;
         seq_inst.csr_write_data_seq = 32'h11111111;   //pmpcfg1 with NA4 with 001
         seq_inst.pmp_en_seq = 0;
         seq_inst.kernel_mode_signal_seq = 0;
         seq_inst.start(env_inst.agent_inst.sequencer_inst);
        end 
         ...
         //pmpcfg3 with NA4 with no  001
       repeat(1) 
	    begin 

         seq_inst.csr_write_addr_seq = 12'h3A3;
         seq_inst.csr_write_data_seq = 32'h11111111;   //pmpcfg3 with NA4 with write access  001
         seq_inst.pmp_en_seq = 0;
         seq_inst.kernel_mode_signal_seq = 0;
         seq_inst.start(env_inst.agent_inst.sequencer_inst);
        end
       ...
       repeat(1) 
        ...
        // seq_inst.csr_write_addr_seq = 12'h3B0;
         ...
         //pmpcfg0 with NA4 with  100 combination
        repeat(1) 
	    begin 

         seq_inst.csr_write_addr_seq = 12'h3A0;
         seq_inst.csr_write_data_seq = 32'h14141414;   //pmpcfg0 with NA4 with 100 
         seq_inst.pmp_en_seq = 0;
         seq_inst.kernel_mode_signal_seq = 0;
         seq_inst.start(env_inst.agent_inst.sequencer_inst);
        end 
...
/*
             ...
             //pmpcfg0 with NA4 with  random combination
        repeat(1) 
	    begin 
